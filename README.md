...
**Other:** Power BI, Git, Docker (beginner), Linux (Fedora)
...
* Hashed PIN authentication (bcrypt)
* Account lockout for failed logins
* Admin tools to view login attempts
* Beneficiary management
* Full transaction history
* PIN reset flows
* CSV export of login attempts

➡️ *Tech:* Python, PostgreSQL, OOP, Logging
...
➡️ *Work in progress; updating regularly.*
...
If you're checking out my repos — thank you! I'm constantly improving, refactoring, and shipping new work.
